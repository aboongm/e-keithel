  ...
  const content = (
    <section className="Login__container">
      <div className="flex flex-col items-center">
        <Link to="/">
          <img className="header__logo" src={monaaz} alt="monaaz" />
        </Link>
        <div className="bg-white border shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-12">
          ...
          <p className="text-sm mt-4 font-medium leading-none login__text">
            ...
            <span
              ...
              className="text-sm font-medium leading-none underline login__text cursor-pointer"
            >
              {' '}
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="bg-gray-100 border rounded focus:outline-none text-base font-medium leading-none login__text py-3 w-full pl-3 mt-2"
              required
            />
          </div>
